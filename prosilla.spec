...
%description -l pl
ProSilla to program przyspieszajacy pobieranie du¿ych plików poprzez otwieranie
wielu po³±czeñ na raz (tak jak inne "przyspieszacze"). Jedyn± ro¿nic± jest to, 
¿e proSilla uzywa ssh zamiast http/ftp do sci±gania. Oczywi¶cie w zwi±zku z 
tym musisz mieæ konto shellowe na docelowym serwerze ¿eby skorzystaæ z tego 
programu.
